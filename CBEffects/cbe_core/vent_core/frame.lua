...
function lib_ventframe.newFrame(params, preset)
	...
	local vent = {
		...
		particleProperties  = fnn(params.particleProperties, params.propertyTable, preset.particleProperties, {}),
		...
		autoCalculateAngles = fnn(params.physics.autoCalculateAngles, params.physics.autoAngle, preset.physics.autoCalculateAngles, true),
